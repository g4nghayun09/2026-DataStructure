...
// console.log("루트 노드의 오른쪽 자식 노드의 오른쪽 자식 노드 : " + tree1.getRightSubTree().getRightSubTree().getData());
// console.log("루트 노드의 왼쪽 자식 노드 : " + tree1.getLeftSubTree().getData());
// console.log("루트 노드의 왼쪽 자식 노드의 왼쪽 자식 노드 : " + tree1.getLeftSubTree().getLeftSubTree().getData());
// console.log("루트 노드의 왼쪽 자식 노드의 왼쪽 자식 노드 : " + tree1.getLeftSubTree().getRightSubTree().getData());
